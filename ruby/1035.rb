...
A, e a soma de C com D for maior que a soma de A e B e se C e D, ambos, forem positivos e se a 
...
puts B > C && D > A && (C + D) > (A + B) && C > 0 && D > 0 && A % 2 == 0 ? "Valores aceitos" : "Valores nao aceitos"